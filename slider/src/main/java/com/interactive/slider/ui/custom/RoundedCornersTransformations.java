package com.interactive.slider.ui.custom;
...
public class RoundedCornersTransformations implements Transformation<Bitmap> {
    ...
    public RoundedCornersTransformations(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundedCornersTransformations(BitmapPool pool, int radius, int margin) {
